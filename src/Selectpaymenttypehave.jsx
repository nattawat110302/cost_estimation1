...
function Selectpaymenttypehave() {
    ...
    return (
        <div class="bg">
            ...
            <div class="container">
                <div class="left">
                    <input type="radio" id="do" name="medclerance" checked="checked"></input>
                    <label htmlFor="do" className="marg-left10">Have Insurance</label>
                    <input type="radio" id="donotdo" className="marg-left20" name="medclerance" onClick={link_Selectpaymenttype}></input>

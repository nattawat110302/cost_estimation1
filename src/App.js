...
import Noteandconfirmcreate from './Noteandconfirmcreate';
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/Noteandconfirmcreate" element={<Noteandconfirmcreate />} />
          <Route path="/Selectpaymenttype" element={<Selectpaymenttype />} />
          <Route path="/Selectpaymenttypehave" element={<Selectpaymenttypehave />} />
